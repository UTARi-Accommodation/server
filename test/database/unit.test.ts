...
import insertUnit from '../dummy/database/insert/unit.json';
import updateUnit from '../dummy/database/update/unit.json';
...
describe('Unit', () => {
    ...
    describe('Insert', () => {
        it('should insert all', async () => {
            await insertToDatabase(insertUnit as Accommodations, 'BTHO');
    ...
    describe('Update', () => {
        it('should update for same data', async () => {
            ...
            await insertToDatabase(updateUnit as Accommodations, 'BTHO');
            const handlerID = '0123038119';
